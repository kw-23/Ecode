                            ...
                            <div class="cart-item" data-course-id="{{ $item->course->id }}" style="animation-delay: {{ $index * 0.1 }}s">
                                ...
                                <div class="item-actions">
                                    ...
                                    <div class="action-buttons">
                                        <form action="{{ route('cart.remove', $item->course->id) }}" method="POST" class="remove-form" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn-icon-only btn-remove" data-course-id="{{ $item->course->id }}" title="Remove from cart">
                                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
